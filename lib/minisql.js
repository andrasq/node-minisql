...
function Packeteer( options ) {
    ...
    this.bufs = []
    this.nbytes = 0
    this.minBytes = options.minBytes || 5
    this.bytesNeeded = options.bytesNeeded || function(buf) { return 4 + my.readUint3(buf, 0) }
    this.extractPayload = options.extractPayload || function(buf) { return buf }
    ...
    this.get = function get( ) {
        ...
        var need = this.bytesNeeded(this.bufs[0])
