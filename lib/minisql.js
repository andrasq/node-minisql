...
function Packeteer( options ) {
    ...
    this.get = function get( ) {
        ...
        var need = this.needed ? this.needed : this.needed = this.bytesNeeded(this.bufs)
        if (this.nbytes < need || need <= 0) return null
        ...
        var chunks = new Array()                // assemble packet out of chunks
